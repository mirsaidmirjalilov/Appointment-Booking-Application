...
public class MedicalRecordServiceImpl implements MedicalRecordService {
    ...
    @Override
    @Cacheable(value = "medicalRecord", key = "#appointmentId + '_' + #requesterId")
    public MedicalRecordResponse getRecordByAppointmentId(Long appointmentId, Long requesterId) {
        MedicalRecord medicalRecord = medicalRecordRepository.findByAppointmentIdAndRequester(appointmentId, requesterId).orElseThrow(() -> new AppointmentNotFoundException("Appointment with id: " + appointmentId + " does not exist"));
